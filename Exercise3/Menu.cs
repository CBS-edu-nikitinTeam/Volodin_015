...
namespace Exercise3
{
    // Дублирование кода - всегда отстойно. Т.е. Я бы реализвал класс PlayMenu, RecordMenu не как статический
    // а как производный от Menu. Потому что статика - особенно статические классы используются, когда обслуживают,
    // делают механические вещи. И от дублированного свитча благодаря наследованию можно было избависят бы.
